...
<head>
    ...
    <title>Sallahly.dz | Modifier profile</title>
</head>
...
<body>
    <div class="w-full h-full min-h-screen relative overflow-hidden">
        ...
        <div class="container relative w-full h-full min-h-[calc(100%-62px)] mx-auto mt-12">
                        ...
                        <div class="flex-auto p-6">
                            <div class="mx-0 mb-4 pb-4 text-center ">
                                <div class="mx-0 mb-4 pb-4 text-center ">
                                    ...
                                    if (isset($_SESSION['user_id']) != "") {
                                        $user_id = $_SESSION['user_id'];
                                        $selectUser = mysqli_query($conn, "SELECT * FROM `users` WHERE id = '$user_id'") or die('query failed');
                            ...
                            <div class="flex flex-wrap">
                                <div class="xl:w-full  lg:w-full  md:w-full  sm:w-full pr-4 pl-4 w-full">
                                    <div class="flex items-center gap-3 justify-end">
                                        <a href="home.php" type="button" id="cancel" name="cancel" class="inline-block align-middle text-center select-none border font-semibold text-[14px] whitespace-no-wrap rounded-md py-3 px-7 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700">Annuler</a>
                                        <input type="submit" id="update" name="update_profile" value="Mis à jour " class="inline-block align-middle text-center select-none cursor-pointer border font-semibold text-[14px] whitespace-no-wrap rounded-md py-3 px-7 leading-normal no-underline bg-[#3b82f6] text-white hover:bg-blue-700">
                                    </div>
                                </div>
                            </div>
                        </form>
