...
if (isset($_POST['send_message'])) {
    if (isset($_SESSION['user_id']) != "") {
        ...
        if ($subject == "" || $message == "") {
            ...
            $query = "INSERT INTO `messageries`(subject, user_id, message) VALUES ('$subject','$user_id','$message')";
        ...
        $_SESSION['message_error'] = 'Le message n`est pas envoyé connecter vous svp!';
    }
}
?>
    ...
    <div class="w-full h-full min-h-full relative">
        ...
        <section class="max-w-[998px] py-6 container mx-auto" id="repairs">
            ...
            <div class="py-10 w-full h-auto">
                ...
                <div class="w-full h-full flex flex-wrap items-stretch  justify-center px-5 gap-5 py-2 text-black">
                    <?php
                    $GetAllModelesRepair = "SELECT * FROM model_reparation INNER JOIN categories ON categories.id = model_reparation.category_id";
                    ...
                    ?>
                            <div class="p-4 flex flex-col" style="background-color: #eee; border: 1px solid #ccc; border-radius: 5px; max-width: 300px;">
                                <h2 class="text-center text-[20px] mb-3 font-bold"><?= $repairModeles['name'] ?></h2>
                                <h2 class="text-center mb-3"><?= $repairModeles['problem'] ?></h2>
                                <p class="text-justify text-[15px] mb-3"> <?= $repairModeles['description'] ?> </p>
                                <p class="text-right font-bold"><?= $repairModeles['price'] ?></p>
                            </div>
                ...
                <div class="w-full h-auto flex items-center justify-center p-2">
                    <a href="commande-repear.php" class="bg-teal-100 hover:bg-white text-teal-800 rounded-full py-3 px-8 shadow-md hover:shadow-2xl transition duration-500 ">Réparer</a>
                </div>
            </div>
        </section>
            ...
            <div class="py-10 w-full h-auto">
                ...
                <div class="w-full h-auto flex items-center justify-around gap-5">
                    <div class="relative   p-2 flex-col">
                        ...
                        <span class="text-blue-600 font-semibold text-[18px] absolute top-[25%] left-[20%]">Professionnalisme</span>
        ...
        <section id="contact-nous" class="max-w-[998px] container relative  py-6 mx-auto text-gray-800">
            <div class="relative overflow-hidden bg-no-repeat bg-cover" style="background-position: 50%; background-image: url('https://mdbootstrap.com/img/new/textures/full/284.jpg'); height: 300px;">
            ...
            <div class=" container text-gray-800 px-4 md:px-12">
                <div class="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6" style="margin-top: -100px; background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
                    <div class="flex flex-wrap ">
                        <div class="grow-0 shrink-0 basis-auto w-full xl:w-full px-3 lg:px-6 mb-8 xl:mb-0 ">
                            <form action="" method="POST" id="form-send-message">
                                <div class="form-group mb-6">
                                    <input type="text" name="subject" class="form-control block w-full px-3 py-1.5 text-base font-normal  text-gray-700  bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="subject" placeholder="sujet" required>
                                </div>
                                <div class="form-group mb-6">
                        ...
                        <a href="https://www.google.com/maps/@36.2579635,2.2334088,15z" class="p-2 w-full pt-4 text-center">
                            <img src="./assets/udbkm.png" alt="Université DJILALI BOUNAAMA" class="border-blue-600 w-full border-[1px] rounded-[4px] hover:scale-105 cursor-pointer h-full object-contain">
                        </a>
                    </div>
                </div>
